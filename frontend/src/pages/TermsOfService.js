...
const SECTIONS = [
  {
    ...
    content: (
      <>
        <p>By accessing or using the Vakar Games website (<strong className="text-[#0A0A0A]">vakargames.com</strong>) or any of our games, you agree to be bound by these Terms of Service. If you do not agree, please stop using our services.</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        <p>Our website and games are provided <strong className="text-[#0A0A0A]">"as is"</strong> and <strong className="text-[#0A0A0A]">"as available"</strong> without warranties of any kind. We do not guarantee uninterrupted access, freedom from errors, or that our services will meet your specific expectations. We reserve the right to modify, suspend, or discontinue any service at any time without notice.</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        <p>These Terms of Service are governed by and construed in accordance with the laws of <strong className="text-[#0A0A0A]">France</strong>. Any dispute arising out of or related to these terms shall be subject to the exclusive jurisdiction of the courts of France.</p>
      </>
    ),
  },
  {
        ...
        <div className="max-w-[1100px] mx-auto px-6">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            ...
            >
              ...
              <div>
                <p className="font-mono text-xs text-[#0A0A0A] font-bold tracking-wider uppercase">Last Revision</p>
                <p className="text-[11px] font-mono text-[#71717A] mt-0.5">September 2026 · France</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="p-6 bg-[#F8F9FA] border border-[#E5E7EB] flex items-center justify-between gap-4 flex-wrap">
              <div>
                ...
                <p className="text-sm font-bold text-[#0A0A0A] mt-0.5">Looking for our Privacy Policy?</p>
                <p className="text-xs text-[#71717A] mt-0.5">Learn how we process, store, and protect your data.</p>
              </div>
              <a
                href="/privacy"
                className="btn-kefir"
