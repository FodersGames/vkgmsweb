      ...
      <div className="bg-[#151520] rounded-xl border border-[#2a2a3c] overflow-hidden">
        <div className="px-6 py-4 border-b border-[#2a2a3c]">
          <div className="flex items-center gap-3">
            ...
            <div><h3 className="text-base font-semibold text-[#e4e4e7]">Website Settings</h3><p className="text-xs text-[#71717a]">Global website configuration</p></div>
          </div>
        </div>
        <div className="p-6">
          <div className={`p-5 rounded-xl border ${maintenance ? 'bg-red-500/5 border-red-500/20' : 'bg-[#1c1c2e] border-[#2a2a3c]'}`}>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <AlertTriangle size={20} className={maintenance ? 'text-red-400' : 'text-[#71717a]'} />
                <div>
                  <h4 className="font-semibold text-[#e4e4e7]">Maintenance Mode</h4>
