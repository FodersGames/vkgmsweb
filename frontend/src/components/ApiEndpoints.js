      ...
      <Card className="overflow-hidden">
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-sm font-semibold text-[#1C1917] dark:text-[#e4e4e7]">API Documentation</h3>
          ...
          {endpoints.map((section, sectionIdx) => (
            <div key={sectionIdx}>
              <div className="flex items-center gap-2 mb-4">
                <div className="h-px flex-1 bg-[#E8E3DB] dark:bg-[#2a2a3c]"></div>
              ...
              <div className="space-y-4">
                {section.items.map((endpoint, endpointIdx) => {
                  ...
                  return (
                    <div key={endpointIdx} className="border border-[#E8E3DB] dark:border-[#2a2a3c] bg-[#F9F7F4] dark:bg-[#111118]">
                      <div className="p-4 border-b border-[#E8E3DB] dark:border-[#2a2a3c] bg-white dark:bg-[#151520]">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3 flex-1">
                            ...
                            <code className="text-sm font-mono text-[#1C1917] dark:text-[#e4e4e7] flex-1">{endpoint.path}</code>
                            {endpoint.auth && (
                          ...
                          <button onClick={() => copyToClipboard(endpoint.example, `url-${uniqueId}`)}
                            className="ml-3 p-2 border border-[#E8E3DB] dark:border-[#2a2a3c] hover:border-[#4ECDC4]/30 transition-colors"
                      ...
                      <div className="p-4 space-y-4">
                        <div>
                          ...
                          <code className="block p-2 bg-[#F0EDE8] dark:bg-[#0d0d14] border border-[#E8E3DB] dark:border-[#2a2a3c] text-[#1C1917] dark:text-[#e4e4e7] text-sm font-mono break-all">
                            {endpoint.example}
                          </code>
                        </div>
                        ...
                        {endpoint.body && (
                          <div>
                            ...
                            <div className="flex items-start gap-2">
                              <pre className="flex-1 p-3 bg-[#F0EDE8] dark:bg-[#0d0d14] border border-[#E8E3DB] dark:border-[#2a2a3c] text-[#1C1917] dark:text-[#e4e4e7] text-sm font-mono overflow-x-auto">
                                {endpoint.body}
                              </pre>
                              <button onClick={() => copyToClipboard(endpoint.body, `body-${uniqueId}`)}
                                className="p-2 border border-[#E8E3DB] dark:border-[#2a2a3c] hover:border-[#4ECDC4]/30 transition-colors">
                        ...
                        {endpoint.auth && (
                          <div>
                            ...
                            <code className="block p-2 bg-[#F0EDE8] dark:bg-[#0d0d14] border border-[#E8E3DB] dark:border-[#2a2a3c] text-[#1C1917] dark:text-[#e4e4e7] text-sm font-mono">
        ...
        <div className="px-6 pb-6">
          <div className="p-4 border border-[#6C5CE7]/30 bg-[#6C5CE7]/5">
            ...
            <p className="text-sm text-[#1C1917] dark:text-[#e4e4e7]/70">
              All game data (items, status, variables, logs) is isolated per project. Each project has its own set of endpoints prefixed with <code className="text-xs bg-[#F0EDE8] dark:bg-[#0d0d14] px-1.5 py-0.5 rounded border border-[#E8E3DB] dark:border-[#2a2a3c] text-[#4ECDC4]">/api/projects/{'{'}&lt;slug&gt;{'}'}</code>.
